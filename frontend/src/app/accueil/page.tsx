            ...
            >
                ...
                <div className="relative z-10 container mx-auto text-center">
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-12 lg:gap-16 px-10 md:px-8 lg:px-16 ">
                        {/* Eco Lieu Card */}
                        <div
                            className={`w-full md:w-1/2 lg:w-1/3 bg-white text-black bg-opacity-0 p-4 md:p-6 shadow-lg flex flex-col ${isSectionVisible3 ? "animate-slideInFromBottom" : "opacity-0"
                                }`}
                        >
                            {/* Card Title */}
