...
export default function Voix() {
  return (
    <main className="bg-black text-white">
      ...
      <section className="pt-16 px-4 md:px-4 lg:px-8 pb-16">
        {/* Intro */}
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm md:text-base leading-relaxed text-gray-200 pb-12">
        ...
        {/* Cartes */}
        <div className="max-w-7xl mx-auto mt-24 grid gap-12 md:grid-cols-3 px-2 md:px-6 items-stretch">
          {/* Carte : La méthode */}
          <div className="flex flex-col items-stretch">
            <article
              className="relative rounded-xs bg-black/40 bg-blend-multiply h-full flex flex-col"
              style={{
            ...
            >
              ...
              <img
                ...
                alt=""
                className="absolute -top-14 -left-10 w-20 h-24 md:w-28 md:h-28 pointer-events-none select-none z-20"
              />

              {/* Overlay + texte */}
              <div className="relative z-10 bg-gradient-to-b from-black/30 via-black/20 to-black/10 backdrop-blur-sm h-full p-4 md:p-4 text-sm leading-relaxed">
                <h3 className="text-xl font-bold text-yellow-500 mb-1 text-center">
                  La méthode
                </h3>
                <p className="text-xs italic text-yellow-300 mb-5 text-center">
                  &quot;Le Champ des Voix - la Voie du Chant&quot;
                </p>
      ...
      <section className="pt-20 px-4 md:px-20 pb-10 text-center">
      ...
      <section className="pt-20 px-4 md:px-20 pb-28">
        <h3 className="text-xl font-semibold text-center mb-8">Avis des stagiaires</h3>
        <AvisSliderVoix />
      </section>
    </main>
  );
